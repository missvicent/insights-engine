...
from app.db.client import get_settings, Settings
...
async def welcome_webhook(
    ...
    if ssettings.resend_webhook_secret is None:
    ...
    logger.info(f"Received Clerk {event_type} webhook event")
    ...
    if event_type == "user.created":
        ...
        if primary_email is None:
            log.warning("user.created with no primary email: user_id=%s", data.get("id"))
